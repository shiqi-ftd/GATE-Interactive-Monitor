//Original from EduGate project
//Modified by Shiqi Zhong
//Email: szhong4@vols.utk.edu
//7/20/2015
...

{
	...
	// ***directly call the CoinChan analysis
	main->CoinChan();
...
void MyMainFrame::CoinChan()
{
	//Maybe full path needed.
	TString RootFileName = "Coin_Chan.root";
	TFile f(RootFileName);
	
	//set the name from Coin_Chan.root to Coin_Chan.gif
